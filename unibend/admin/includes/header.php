...
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container">
    <a class="navbar-brand" href="#">Administrator : <span><?php session_start();  if(isset($_SESSION['username'])) {echo $_SESSION['username'];}else { echo 'Logging in';}?></span> </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      // session_start();
        ...
        <a class="nav-link " aria-current="page" href="post.php">Post's_info </a>
              ...
              echo '<li><a class="dropdown-item" href="man-post.php">Manage Posts</a></li>';
              echo '<li><a class="dropdown-item" href="post.php">Upload Posts</a></li>';

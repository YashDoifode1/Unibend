  ...
  <div class="container">
    ...
    echo'<form id="searchForm">
      ...
      <ul class="navbar-nav ms-auto">
        ...
        echo '</li>
        <li class="nav-item">
        <a  style="color: red;" class="nav-link " aria-current="page" href="meet.php">MEET </a>
        </li>';

       echo' <li class="nav-item">
        <a class="nav-link " aria-current="page" href="post.php">Posts </a>
        </li>';
              ...
              echo '<li class="nav-item">';
              echo '<a class="nav-link" href="admin/login.php"><span style="color: green;">Admin Login</span> </a>'; // Link to login page
              echo '</li>';
              echo '<li class="nav-item">';
              echo '<a class="nav-link" href="login.php">Login</a>'; // Link to login page
              echo '</li>';
              echo '<li class="nav-item">';
              echo '<a class="nav-link" href="register.php">Register</a>'; // Link to register page
              echo '</li>';
